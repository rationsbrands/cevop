    ...
    return (
      <PageShell>
        <div className="space-y-4">
          <div className="w-10 h-10 rounded-full bg-[color-mix(in_srgb,var(--danger)_15%,transparent)] border border-[var(--danger)] flex items-center justify-center text-[var(--danger)] text-lg font-bold">
            !
          </div>
    ...
    <PageShell>
      <div className="space-y-2">
        ...
        <p className="text-sm text-[var(--muted)]">
          You’ve been invited to join your organisation.
        </p>
      </div>
      ...
      <div className="card p-4 space-y-1">
        ...
        <p className="text-[var(--muted)] text-sm">
          Role: {ROLE_LABELS[inviteInfo?.role ?? ''] ?? inviteInfo?.role}
        </p>
        <p className="text-xs text-[var(--muted)] mt-2">
          Signing up as: <span className="text-[var(--text)]">{inviteInfo?.email}</span>
        </p>
      </div>
